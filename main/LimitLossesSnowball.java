...
//限虧雪球
public class LimitLossesSnowball{
    public final String product_Name = "限亏雪球";
    public final int ID = 1;
    public product pro;
    public double S_T_limit; //保底水平
    public LimitLossesSnowball(double S_T_limit) {
    ...
    public static void main(String[] args) {
        ...
        LimitLossesSnowball snowball = new LimitLossesSnowball(0.8);
        double[] cal = snowball.cal(pro);
        System.out.println(Arrays.toString(cal)); //[0.9953136454506522, 0.3713672134678049, -4.5989502001698686]
    }
}
