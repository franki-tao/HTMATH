...
public class GuaranteedSnowball {
    public final String product_Name = "保本雪球";
    public final int ID = 17;
    public product pro;
    public double min_rate;
    public double mu_O;

    public GuaranteedSnowball(double min_rate, double mu_O) {
    ...
    public static void main(String[] args) {
        ...
        GuaranteedSnowball snowball = new GuaranteedSnowball(
                0.001,
                0.06
        );
        System.out.println(Arrays.toString(snowball.cal(pro))); //[1.0000519418145546, 0.052088504497270205, -0.5237070443171938]
    }
