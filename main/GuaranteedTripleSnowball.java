...
public class GuaranteedTripleSnowball {
    public final String product_Name = "保本三元雪球";
    public final int ID = 19;
    public product pro;
    //"min_rate":0.001,"mu_O":0.06,"mu_f":0.04
    public double min_rate;
    public double mu_O;
    public double mu_f;

    public GuaranteedTripleSnowball(double min_rate, double mu_O, double mu_f) {
    ...
    public static void main(String[] args) {
        ...
        GuaranteedTripleSnowball snowball = new GuaranteedTripleSnowball(
                0.001,
                0.06,
                0.04
        );
        System.out.println(Arrays.toString(snowball.cal(pro))); //[1.0023215564420478, 0.03250106928794161, -0.6488568599542348]
    }
